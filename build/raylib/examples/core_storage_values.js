...
// refer to Module (if they choose; they can also define Module)
  ...
  (function() {
   var loadPackage = function(metadata) {
      ...
      var PACKAGE_NAME = 'raylib/examples/core_storage_values.data';
          ...
          DataRequest.prototype.byteArray = byteArray;
            ...
            for (var i = 0; i < files.length; ++i) {
              DataRequest.prototype.requests[files[i].filename].onload();
                ...
                Module['removeRunDependency']('datafile_raylib/examples/core_storage_values.data');

      };
      Module['addRunDependency']('datafile_raylib/examples/core_storage_values.data');
...
var wasmBinaryFile = 'core_storage_values.wasm';
