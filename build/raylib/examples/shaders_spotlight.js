...
// refer to Module (if they choose; they can also define Module)
  ...
  (function() {
   var loadPackage = function(metadata) {
      ...
      var PACKAGE_NAME = 'raylib/examples/shaders_spotlight.data';
          ...
          DataRequest.prototype.byteArray = byteArray;
            ...
            for (var i = 0; i < files.length; ++i) {
              DataRequest.prototype.requests[files[i].filename].onload();
                ...
                Module['removeRunDependency']('datafile_raylib/examples/shaders_spotlight.data');

      };
      Module['addRunDependency']('datafile_raylib/examples/shaders_spotlight.data');
...
var wasmBinaryFile = 'shaders_spotlight.wasm';
