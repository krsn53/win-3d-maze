...
// refer to Module (if they choose; they can also define Module)
  ...
  (function() {
   var loadPackage = function(metadata) {
      ...
      var PACKAGE_NAME = 'raylib/examples/core_drop_files.data';
          ...
          DataRequest.prototype.byteArray = byteArray;
            ...
            for (var i = 0; i < files.length; ++i) {
              DataRequest.prototype.requests[files[i].filename].onload();
                ...
                Module['removeRunDependency']('datafile_raylib/examples/core_drop_files.data');

      };
      Module['addRunDependency']('datafile_raylib/examples/core_drop_files.data');
...
var wasmBinaryFile = 'core_drop_files.wasm';
