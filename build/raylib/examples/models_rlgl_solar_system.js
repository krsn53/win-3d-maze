...
// refer to Module (if they choose; they can also define Module)
  ...
  (function() {
   var loadPackage = function(metadata) {
      ...
      var PACKAGE_NAME = 'raylib/examples/models_rlgl_solar_system.data';
          ...
          DataRequest.prototype.byteArray = byteArray;
            ...
            for (var i = 0; i < files.length; ++i) {
              DataRequest.prototype.requests[files[i].filename].onload();
                ...
                Module['removeRunDependency']('datafile_raylib/examples/models_rlgl_solar_system.data');

      };
      Module['addRunDependency']('datafile_raylib/examples/models_rlgl_solar_system.data');
...
var wasmBinaryFile = 'models_rlgl_solar_system.wasm';
