...
// refer to Module (if they choose; they can also define Module)
  ...
  (function() {
   var loadPackage = function(metadata) {
      ...
      var PACKAGE_NAME = 'raylib/examples/textures_to_image.data';
          ...
          DataRequest.prototype.byteArray = byteArray;
            ...
            for (var i = 0; i < files.length; ++i) {
              DataRequest.prototype.requests[files[i].filename].onload();
                ...
                Module['removeRunDependency']('datafile_raylib/examples/textures_to_image.data');

      };
      Module['addRunDependency']('datafile_raylib/examples/textures_to_image.data');
...
var wasmBinaryFile = 'textures_to_image.wasm';
