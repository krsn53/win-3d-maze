...
// refer to Module (if they choose; they can also define Module)
  ...
  (function() {
   var loadPackage = function(metadata) {
      ...
      var PACKAGE_NAME = 'raylib/examples/audio_module_playing.data';
          ...
          DataRequest.prototype.byteArray = byteArray;
            ...
            for (var i = 0; i < files.length; ++i) {
              DataRequest.prototype.requests[files[i].filename].onload();
                ...
                Module['removeRunDependency']('datafile_raylib/examples/audio_module_playing.data');

      };
      Module['addRunDependency']('datafile_raylib/examples/audio_module_playing.data');
...
var wasmBinaryFile = 'audio_module_playing.wasm';
