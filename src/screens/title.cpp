...
Screen* Title::update(){
    ...
    case 0:
    {
        m_app->config().playMode =((int)(m_tmp + NUM_PLAY_MODES + drag.x*NUM_PLAY_MODES*3)) % NUM_PLAY_MODES;

        break;
    }
    case 1:
    {
        m_app->config().mapSize =  drag.x*50 + m_tmp;
